...
public class IfScriptChecker implements ConditionChecker<IfScript> {
    ...
    private boolean isSatisfied(final ScriptEngine scriptEngine, final ScriptContext scriptContext, final String... scripts) throws Exception {
    ...
    private ScriptContext createScriptContext(final Object testInstance, final Object extraContext) {
        ...
        ScriptUtils.addAttribute(context, CONTEXT_PROPS, PropUtils.convertPropertiesToMap(System.getProperties()));
        return context;
    }

    @SuppressWarnings("rawtypes")
    private Object getExtraContext(final Object testInstance, final Class<? extends Callable> providerClass) throws Exception {
