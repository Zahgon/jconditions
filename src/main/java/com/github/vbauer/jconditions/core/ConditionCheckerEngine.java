...
public final class ConditionCheckerEngine {
    ...
    public static ConditionChecker<?> detectFailedChecker(final Object instance, final FrameworkMethod method) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }

    private static ConditionChecker<?> findCheckerByAnnotations(final Object instance, final Annotation parent, final Collection<Annotation> annotations) {
        for (final Annotation annotation : annotations) {
            final ConditionChecker<?> checker = getConditionChecker(instance, parent, annotation);
            if (checker != null) {
                return checker;
            }
        }
    ...
    private static ConditionChecker<?> getConditionChecker(final Object instance, final Annotation parent, final Annotation annotation) {
        if (!ReflexUtils.isInJavaLangAnnotationPackage(annotation)) {
            ...
            final Collection<Annotation> extra = Arrays.asList(annotationType.getAnnotations());
    ...
    private static <T> ConditionChecker<T> findCheckerByCondition(final T instance, final Annotation parent, final Condition condition) {
    ...
    private static Collection<Annotation> findAllAnnotations(final Object instance, final FrameworkMethod method) {
